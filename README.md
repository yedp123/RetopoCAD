...
CoACD (Collision-Aware Convex Decomposition) by Wei et al. - The genius C++ engine powering the Auto-Blocker.

build123d & OCP - The incredible Python wrapper for the OpenCASCADE CAD kernel, used for boolean unions, sewing, and STEP generation.

trimesh - For parsing and graph analysis.

fast-simplification - For the high-speed pre-decimation pass.
